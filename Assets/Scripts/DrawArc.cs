...
using UnityEngine;
//制作者　小笠原ジェリック
//参考サイト　https://baba-s.hatenablog.com/entry/2018/02/05/090000

public class DrawArc : MonobitEngine.MonoBehaviour
{
    /// <summary>
    /// 放物線の描画ON/OFF
    /// </summary>
    ...
    private Material arcMaterial = null;
    ...
    {
        // 初速度と放物線の開始座標を更新
        initialVelocity = playerController.GetShootVelocity;
        arcStartPosition = playerController.InstantiatePosition;
    ...
    private float GetArcHitTime(float startTime, float endTime)
    {
        ...
        if (Physics.Linecast(startPosition, endPosition, out hitInfo,layerMask))
        {
